...
### Documentation Stage
- [ ] Update planning documents in `planning/finished/`:
...
- [ ] Move document to `planning/finished/` directory
...
- `planning/finished/250606a_semantic_search_implementation.md`
- `planning/finished/250607a_semantic_search_caching.md`
- `planning/finished/250612a_semantic_search_to_highlights_refactor.md`
