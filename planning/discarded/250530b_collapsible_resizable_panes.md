...
- `planning/250530a_shadcn_ui_adoption.md` - **Prerequisite**: shadcn/ui setup must be completed first
...
1. **Dependency on shadcn/ui**: This work cannot begin until shadcn/ui setup is complete from `planning/250530a_shadcn_ui_adoption.md`
...
- [ ] **Dependency check**: Verify `planning/250530a_shadcn_ui_adoption.md` Stage 2-3 are complete
