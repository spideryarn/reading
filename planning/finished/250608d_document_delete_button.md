...
- `docs/reference/DESIGN_OVERVIEW.md` - Phosphor icons usage and UI patterns, specifically delete button styling
- `docs/reference/DESIGN_SHADCN_UI_REFERENCE.md` - Dialog component for confirmation modals
