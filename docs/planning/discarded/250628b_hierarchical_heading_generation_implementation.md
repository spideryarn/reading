...
- `docs/planning/finished/250620c_glossary_generate_more_timeout_mitigation.md` - Progressive loading pattern with `more_entities_available` signal that we'll adapt
