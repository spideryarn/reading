...
The existing glossary feature (tracked in `docs/planning/250526e_glossary_feature.md` and `docs/planning/250526f_glossary_click_to_scroll_and_tooltips.md`) extracts entities using LLM and enables click-to-scroll navigation. However, the current `findFirstOccurrence()` function in `components/document-viewer.tsx:47-67` uses basic substring matching that produces false positives.
...
- `docs/planning/250526e_glossary_feature.md` - Base glossary implementation  
- `docs/planning/250526f_glossary_click_to_scroll_and_tooltips.md` - Click-to-scroll design decisions
