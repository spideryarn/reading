...
- `docs/planning/250530b_collapsible_resizable_panes.md` - Resizable component patterns
- `docs/planning/250530a_shadcn_ui_adoption.md` - shadcn/ui setup (prerequisite)
...
- [x] Verify shadcn/ui is properly set up (`docs/planning/250530a_shadcn_ui_adoption.md`)
...
- [x] Move to `docs/planning/finished/` folder
