...
- `docs/planning/finished/250606a_semantic_search_implementation.md` - Complete semantic search feature implementation without caching
- `docs/planning/finished/250602a_database_integration_completion.md` - Shows how other AI features store results in `document_enhancements`
