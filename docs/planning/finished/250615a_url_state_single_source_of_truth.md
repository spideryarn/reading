...
- `docs/planning/finished/250614a_tool_url_state_management.md` – original multi-tool URL state plan (to be updated)
...
- `docs/planning/250614b_unified_tool_registry_architecture.md` – registry will dispatch tab changes
- `docs/planning/250614c_llm_tool_function_calling.md` – LLM functions will rely on URL parameters
