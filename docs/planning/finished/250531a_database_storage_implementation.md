...
- `docs/planning/ignore_or_later/250530i_llm_token_usage_tracking.md` - Detailed plan for LLM usage tracking integration
...
- [ ] Move this document to `docs/planning/finished/` - After final review
