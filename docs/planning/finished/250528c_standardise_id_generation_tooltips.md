...
- `docs/MUTATIONS_DOCUMENT_CONTENT_REVERSIBLE_TRANSFORMS.md` - Explains the document mutation system for AI headings
- `docs/ARCHITECTURE.md` - Overall system architecture including mutation design
- `docs/planning/250526d_deterministic_id_generation.md` - Original ID generation design decisions
- `docs/planning/250526g_ai_generated_headings.md` - AI heading implementation details
- `docs/planning/250527a_reversible_document_mutations.md` - Comprehensive mutation system documentation
