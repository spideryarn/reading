...
- `docs/planning/250605a_chat_database_integration.md` - Original chat persistence planning
...
- [ ] Move this planning doc to `docs/planning/finished/` after user review
