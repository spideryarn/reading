...
- `docs/planning/250614b_unified_tool_registry_architecture.md` - Core registry (prerequisite)
...
- `docs/planning/250614b_unified_tool_registry_architecture.md` - Core registry implementation
- `docs/planning/250614d_tool_execution_framework.md` - Next step after this
