...
- `docs/planning/250608c_vertical_icon_navigation_bar.md` - Current navigation implementation that command palette will complement
...
- [ ] Update planning documentation
  - [ ] Move current planning doc to `docs/planning/finished/`
