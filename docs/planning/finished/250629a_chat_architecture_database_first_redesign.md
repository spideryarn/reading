...
- `docs/planning/250616a_multi_chat_threads.md` - Future multi-thread UI requirements
- `docs/planning/finished/250629a_auth_helpers_consolidation.md` - new auth refactor
