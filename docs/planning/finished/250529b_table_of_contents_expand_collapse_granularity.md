...
- `docs/DESIGN_OVERVIEW.md` - UI patterns including expand/collapse button styling (up/down arrows used in Summary tab)
...
- [ ] Animation transitions for expand/collapse actions
  - See `docs/planning/250530a_shadcn_ui_adoption.md` - "Future Stage: Animations for Expand/Collapse"
