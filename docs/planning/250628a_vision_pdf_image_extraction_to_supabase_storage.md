...
- **Vision Pipeline Planning**: `docs/planning/250627c_vision_based_pdf_processing_pipeline.md` - Current vision-based processing implementation
...
- [x] **Update vision pipeline documentation**: Revise `docs/planning/250627c_vision_based_pdf_processing_pipeline.md` with image extraction details
...
- [x] Update documentation ✅ Updated `docs/planning/250627c_vision_based_pdf_processing_pipeline.md` to reflect Phase 2 architecture
