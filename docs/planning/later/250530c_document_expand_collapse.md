...
- Original merge planning: `docs/planning/finished/250528b_merge_document_panes.md`
...
- Related features:
  ...
  - `docs/planning/250529a_ai_collapse_expand_summaries.md` - AI summaries for collapsed blocks
...
- [ ] See detailed planning doc: `docs/planning/250529a_ai_collapse_expand_summaries.md`
...
See the full analysis in `docs/planning/finished/250528b_merge_document_panes.md` for complete details.
