...
This builds upon the basic collapse/expand functionality from Stage 3 of `docs/planning/250528b_merge_document_panes.md`, replacing simple truncation with intelligent summarisation.
...
- `docs/planning/250528b_merge_document_panes.md` - Prerequisite merge of document panes (Stages 1-5 must be complete)
