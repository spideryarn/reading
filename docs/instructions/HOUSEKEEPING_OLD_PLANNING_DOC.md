...
- If not:
  ...
  - Follow instructions in docs/instructions/RENAME_OR_MOVE.md to move the planning doc to docs/planning/finished/ and update references to the new path with a subagent
