...
- Update `docs/CODING_GUIDELINES.md` with useful tips, gotchas, brief rationale, urls, etc
...
Add/update the section in `docs/reference/ARCHITECTURE_DECISIONS.md` that describes our technology stack concisely, pulling from `docs/reference/ARCHITECTURE_DECISIONS.md`, `docs/SETUP.md`, etc, and make sure this is up-to-date and complete.

Make sure `docs/CODING_GUIDELINES.md` is referenced in `CLAUDE.md` and any other appropriate docs (e.g.`CODING_PRINCIPLES.md`, `docs/reference/ARCHITECTURE_DECISIONS.md`, etc). And add very concise notes inside `CLAUDE.md` for any particularly important points.
