...
- `docs/instructions/UPDATE_INDEX_FOR_DOCUMENTATION.md` - Documentation maintenance process (includes updating CLAUDE.md)
...
- **Planning docs** - Point to `docs/planning/*.md` for recent decisions
...
- **Step-by-step tutorials** - These belong in `docs/reference/SETUP_DEVELOPMENT_ENVIRONMENT.md`
