...
## See also
- `docs/WRITING_EVERGREEN_DOCS.md` – conventions for evergreen documentation like this file.
- `docs/WRITING_PLANNING_DOCS.md` – how to record stage-based action plans (used by the Appendix we add to planning docs).
...
3. **Prioritise** findings into stages (A, B, C…) with task lists following `WRITING_PLANNING_DOCS.md`.
