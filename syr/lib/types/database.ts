...
export const AiProviders = ['anthropic', 'google', 'openai'] as const
export type AiProvider = typeof AiProviders[number]

export const PromptTypes = ['chat', 'summarise', 'glossary', 'headings', 'tweet-thread'] as const
export type PromptType = typeof PromptTypes[number]

export const CallStatuses = ['pending', 'success', 'failed', 'timeout'] as const
export type CallStatus = typeof CallStatuses[number]

export const EnhancementTypes = ['summary', 'glossary', 'headings', 'tweet-thread'] as const
